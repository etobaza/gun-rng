...
- The local equipped weapon updates `GunRoot` after all camera effects. This order keeps ADS springs aligned with the final camera transform without moving constraint-driven child parts directly.
